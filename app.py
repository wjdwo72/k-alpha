...
window.__KIS_PRICES__   = {prices_json.replace('</script>', '<\\/script>').replace('<!--', '<\\!--')};
window.__KIS_BALANCE__  = {balance_json.replace('</script>', '<\\/script>').replace('<!--', '<\\!--')};
window.__KIS_PRICE_TS__ = {json.dumps(price_ts)};
window.__SCAN_RESULT__  = {scan_json.replace('</script>', '<\\/script>').replace('<!--', '<\\!--')};
